...
public class DatabaseRefs {
    ...
    public DatabaseReference referenceFeedback = mainReference.child("Feedback").child(uid);
    public DatabaseReference referenceHelplineMsg = mainReference.child("HelplineMessages").child(uid);
}
